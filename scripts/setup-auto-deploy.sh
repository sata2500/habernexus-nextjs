...
print_summary() {
    ...
    echo ""
    echo -e "  ${WHITE}Adım 1: GitHub Repository Ayarlarına Gidin${NC}"
    echo -e "  - Projenizin GitHub sayfasına gidin."
    echo -e "  - Sağ üstteki ${WHITE}Settings${NC} sekmesine tıklayın."
    echo ""
    echo -e "  ${WHITE}Adım 2: Actions Secrets Menüsünü Bulun${NC}"
    echo -e "  - Sol menüdeki ${WHITE}Security${NC} başlığı altında,"
    echo -e "  - ${WHITE}Secrets and variables${NC} seçeneğine tıklayın."
    echo -e "  - Açılan alt menüden ${WHITE}Actions${NC} seçeneğine tıklayın."
    echo ""
    echo -e "  ${WHITE}Adım 3: Yeni Secret'lar Ekleyin${NC}"
    echo -e "  - ${WHITE}New repository secret${NC} butonuna tıklayarak aşağıdaki iki secret'ı oluşturun:"
    echo ""
    echo -e "  ${WHITE}Secret 1:${NC}"
    echo -e "     - Name:   ${CYAN}DEPLOY_WEBHOOK_URL${NC}"
    echo -e "     - Value:  ${YELLOW}http://${server_ip}:${WEBHOOK_PORT}/webhook${NC}"
    echo ""
    echo -e "  ${WHITE}Secret 2:${NC}"
    echo -e "     - Name:   ${CYAN}DEPLOY_WEBHOOK_SECRET${NC}"
    echo -e "     - Value:  ${YELLOW}${WEBHOOK_SECRET}${NC}"
    echo ""
    echo -e "${YELLOW}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo ""
