...
**AI Ajanları:** Bu rehberdeki branch stratejisi ve commit formatı gibi kurallar sizin için de geçerlidir. Ancak, sizin ana yönerge setiniz [AI_DEVELOPMENT_GUIDE.md](docs/ai-agents/AI_DEVELOPMENT_GUIDE.md) ve `docs/ai-agents/` klasöründeki tüm protokollerdir. Lütfen öncelikle o belgeleri inceleyin.
