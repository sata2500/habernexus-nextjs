...
// Demo RSS kaynakları
const demoFeeds = [
  { id: '1', name: 'TRT Haber', url: 'https://www.trthaber.com/rss', category: 'Gündem', isActive: true, lastFetch: '5 dakika önce', articleCount: 245 },
  { id: '2', name: 'Anadolu Ajansı', url: 'https://www.aa.com.tr/rss', category: 'Gündem', isActive: true, lastFetch: '10 dakika önce', articleCount: 312 },
  { id: '3', name: 'Bloomberg HT', url: 'https://www.bloomberght.com/rss', category: 'Ekonomi', isActive: true, lastFetch: '15 dakika önce', articleCount: 189 },
  { id: '4', name: 'Webrazzi', url: 'https://webrazzi.com/feed', category: 'Teknoloji', isActive: true, lastFetch: '20 dakika önce', articleCount: 156 },
  { id: '5', name: 'Sporx', url: 'https://www.sporx.com/rss', category: 'Spor', isActive: false, lastFetch: '2 saat önce', articleCount: 98 },
  { id: '6', name: 'BBC Türkçe', url: 'https://www.bbc.com/turkce/rss', category: 'Dünya', isActive: true, lastFetch: '25 dakika önce', articleCount: 203 },
]
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
          ...
          <p className="text-2xl font-bold text-gray-900 dark:text-white">{feeds.reduce((acc, f) => acc + f.articleCount, 0).toLocaleString('tr-TR')}</p>
        </div>
        <div className="bg-white dark:bg-gray-800 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
          <p className="text-sm text-gray-600 dark:text-gray-400">Son Güncelleme</p>
          <p className="text-2xl font-bold text-gray-900 dark:text-white">5 dk</p>
        </div>
      </div>
          ...
          <table className="w-full">
            <thead className="bg-gray-50 dark:bg-gray-700/50">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Makale</th>
            ...
            <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
              {filteredFeeds.map((feed) => (
                <tr key={feed.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                  ...
                  <td className="px-6 py-4 text-sm text-gray-500">{feed.lastFetch}</td>
                  <td className="px-6 py-4 text-sm text-gray-900 dark:text-white font-medium">{feed.articleCount}</td>
                  <td className="px-6 py-4 text-right">
                    <div className="flex items-center justify-end space-x-2">
                      <button className="p-2 text-gray-500 hover:text-blue-600 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors">
                        <RefreshCw className="w-4 h-4" />
                      </button>
                      <button className="p-2 text-gray-500 hover:text-blue-600 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors">
                        <Edit className="w-4 h-4" />
                      </button>
                      <button className="p-2 text-gray-500 hover:text-red-600 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 w-full max-w-md mx-4">
            ...
            <form className="space-y-4">
              ...
              <div>
                ...
                <select className="w-full px-4 py-2 bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                  <option value="gundem">Gündem</option>
                  <option value="ekonomi">Ekonomi</option>
                  <option value="teknoloji">Teknoloji</option>
                  <option value="spor">Spor</option>
              ...
              <div className="flex items-center space-x-2">
                ...
                <label htmlFor="isActive" className="text-sm text-gray-700 dark:text-gray-300">Aktif olarak başlat</label>
              </div>
